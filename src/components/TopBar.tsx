...
const TopBar: React.FC<TopBarProps> = ({ onMenuClick }) => {
  ...
  const profile = {
    ...
    image:
      user?.image ||
      "https://lh3.googleusercontent.com/aida-public/AB6AXuDRBQNLO5G80U13E2OG_2VW1cuyPritJ3TziMTvtIEx0YlB5mUTcQhRRO7pKf1afUcEc1VK105g19dW3zYFSjkGNwBNZwn6zTNn6y1TnLDhglZUQKbIntfpVcjtMxvN2ujLz94lykq9CXilEh62OmEtPsQcB6gkHMlUYuAKeBhukiv4BnU1r1R-kTDmCO7pq4_ZL6WJmEJ8GyOYCrIN-uLJH0poheboLMP78cZHgeBVJ_ICByu5xcnGWpRzq65d7TYre8dP4lSWiHQ",
  };
            ...
            {isDropdownOpen && (
              <div className="absolute right-0 mt-2 w-56 bg-surface-container-lowest border border-outline-variant rounded-2xl shadow-xl py-2 z-50 animate-in fade-in zoom-in duration-200">
                ...
                <button
                  ...
                  className="w-full flex cursor-pointer items-center gap-3 px-4 py-2.5 text-sm text-error hover:bg-error/5 transition-colors"
                >
                  <LogOut size={18} />
                  Logout
                </button>
